        ...
        <nav className="container max-w-5xl flex items-center justify-between mx-auto">
          <div className="flex lg:flex-1">
            <Link href="/" className="flex items-center gap-2 shrink-0">
              <Image src="/logo.svg" alt="Logo" width={24} height={24} className="w-6 md:w-7" />
              <span className="font-extrabold text-lg">TrackFast</span>
            </Link>
          </div>
          <div className="hidden lg:flex lg:justify-end lg:flex-1">
            <Link href="/login" className="btn btn-sm bg-[rgb(166,173,187)] text-gray-800 hover:bg-[rgb(146,153,167)] flex items-center justify-center h-full">
              Login
            </Link>
          </div>
        </nav>
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center justify-center gap-16 lg:gap-20 px-8 py-16 lg:py-24">
          <div className="relative flex flex-col gap-12 lg:gap-16 items-center justify-center text-center">
            ...
            <p className="text-lg text-base-content-secondary leading-relaxed max-w-md mx-auto">
              Let TrackFast track your job applications from Indeed and LinkedIn, so you can focus on landing your dream job.
            </p>
            <Link href="/signup" className="btn btn-primary btn-block group !btn-wide">
              Get Started
